...
*
* Modified by Cameron Burnham on Mar. 6, 2025
* The script was modified to blink the LED at a rate of 1 second ON, 1 second OFF
* and print an error message if an invalid argument is passed through.
* Invoke the script using ./myMakeLED.c {argument to control light mode} 
*
* */
